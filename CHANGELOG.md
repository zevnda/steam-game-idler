[![Downloads](https://img.shields.io/github/downloads/zevnda/steam-game-idler/1.8.6/total?style=for-the-badge&logo=github&color=137eb5)](https://github.com/zevnda/steam-game-idler/releases/download/1.8.6/Steam.Game.Idler_1.8.6_x64-setup.exe)
...
- Refactored the `achievement manager` feature that comes with significant changes
  ...
  - Achievement data is now pulled directly from the Steam client, this means
    ...
    - Achievement data is stored locally in `AppData\Roaming\com.zevnda.steam-game-idler\achievement_data`
      - These files are generally only a few KiB and can be deleted via `settings > clear data`

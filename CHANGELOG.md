...
- Added the option to schedule tasks, so when when feature X finishes, automatically start feature Y
  - The option can be enbaled in both `settings > card farming` and `settings > achievement unlocker`

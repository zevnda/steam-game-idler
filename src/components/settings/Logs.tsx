    ...
    return (
        <div className='relative flex flex-col gap-4'>
            <div className='flex flex-col gap-4 border border-border rounded-lg p-3 bg-titlebar'>
                ...
                <div className={cn(
                    'bg-container border border-border text-xs rounded-tl-lg rounded-tr-lg',
                    GeistMono.className
                )}>
                    <table className='w-full border-collapse'>
                        <thead className='sticky top-0'>
                            <tr className='border-b border-border bg-tablehead'>
                                <th className='text-left p-1.5 w-[160px] rounded-tl-lg'>
                                    {t('settings.logs.time')}
                                </th>
                                <th className='text-left p-1.5 rounded-tr-lg'>

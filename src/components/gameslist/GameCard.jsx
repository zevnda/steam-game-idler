...
import { handleIdle, viewAchievments, viewStorePage, viewGameSettings } from '@/src/utils/gameslist/gameCardHandler';
...
export default function GameCard({ gameList }) {
                    ...
                    <div key={item.appid} className='relative group'>
                        ...
                        <div className='absolute top-1 right-1 opacity-0 group-hover:opacity-100 transition-opacity duration-200'>
                            <CardMenu
                                ...
                                setCurrentIdleList={setCurrentIdleList}

    ...
    >
      <ModalContent>
        {(onClose: () => void) => (
          <>
            <ModalHeader
              className='flex justify-between items-center w-full bg-modalheader border-b border-border'
            ...
            <ModalFooter className='bg-modalfooter border-t border-border'>
              <div className='flex justify-center items-center gap-4'>
                ...
                <Button size='sm' className='font-semibold rounded-lg bg-dynamic text-button-text' onPress={onClose}>
                  {t('common.continue')}
                </Button>
              </div>
            </ModalFooter>

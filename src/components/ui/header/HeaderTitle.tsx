...
export default function HeaderTitle(): ReactElement {
    ...
    const formatTitleName: Record<string, string> = {
        ...
        'games': 'Your Games',
        'idling': 'Idling Games',
        'customlists/card-farming': 'Card Farming',
        'customlists/achievement-unlocker': 'Achievement Unlocker',
        'customlists/auto-idle': 'Automatic Idler',
        'customlists/favorites': 'Favorites',

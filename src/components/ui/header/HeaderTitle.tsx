...
export default function HeaderTitle(): ReactElement {
    ...
    return (
        <div className='absolute left-1/2 transform -translate-x-1/2 flex items-center justify-center gap-2' data-tauri-drag-region>
            <svg
                ...
                <p className='font-semibold truncate' data-tauri-drag-region>
                    {showAchievements && (
                        <>
                            ...
                            <span className='truncate' data-tauri-drag-region>{formatTitleName[currentTab]}</span>
                        </>
                    )}
                    ...
                    {!showAchievements && activePage === 'settings' && (
                        <>
                            ...
                            <span className='truncate' data-tauri-drag-region>{formatTitleName[currentSettingsTab]}</span>
                        </>
                    )}

                    {!showAchievements && activePage !== 'settings' && (
                        <span className='truncate' data-tauri-drag-region>{formatTitleName[activePage]}</span>
                    )}
                </p>
            </div>
        </div>

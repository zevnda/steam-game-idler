...
interface AchievementButtonsHook {
  ...
  handleUnlockAll: (appId: number, appName: string, achievements: Achievement[], onClose: () => void) => Promise<void>
  handleLockAll: (appId: number, appName: string, achievements: Achievement[], onClose: () => void) => Promise<void>
}

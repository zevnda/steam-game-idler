...
<Steps>
    ...
    ### Report Issues
    If you find persistent errors, include relevant log excerpts when [reporting issues on GitHub](https://github.com/steam-game-idler/steam-game-idler/issues/new?template=issue_report.yml)
</Steps>
...
2. **Search existing issues** on the [GitHub repository](https://github.com/steam-game-idler/steam-game-idler/issues)

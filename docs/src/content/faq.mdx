...
<details>
    ...
    > SGI requires your Steam community credentials for the account that you plan to farm cards on to see if games in your library have card drops remaining or not. Read the [Steam Credentials](/steam-credentials) section for more information
</details>

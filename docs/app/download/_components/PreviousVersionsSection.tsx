      ...
      <div className='container mx-auto px-4 sm:px-6 md:px-8 max-w-2xl'>
        <FadeIn className='text-center mb-12'>
          ...
          <p className='text-text-muted leading-relaxed'>
            Portable .zip downloads of past releases, kept around for compatibility. They no longer
            receive bug fixes or security updates, and won&apos;t automatically update.
          </p>
        </FadeIn>

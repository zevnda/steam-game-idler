        ...
        <div className='space-y-8'>
          ...
          <section>
            ...
            <ul className='list-disc pl-6 space-y-2 mb-4'>
              <li>
                <strong>Game Idling:</strong> Simulate gameplay to increase playtime hours for games
                in your Steam library
              </li>
              <li>
                <strong>Trading Card Farming:</strong> Automatically idle games to earn Steam
                trading cards and manage marketplace listings
              </li>
              <li>
                <strong>Achievement Management:</strong> Unlock, lock, or toggle achievements for
                games you own
              </li>
              <li>
                <strong>Achievement Automation:</strong> Automatically unlock achievements with
                human-like behavior patterns
              </li>
              <li>
                <strong>Auto-Idling:</strong> Automatically start idling selected games when the
          ...
          <section>
            ...
            <ul className='list-disc pl-6 space-y-2 mb-4'>
              ...
              <li>
                <strong>Recurring Billing:</strong> PRO subscriptions are billed on a monthly
                recurring basis unless canceled
              </li>
              <li>
              ...
              <li>
                <strong>Payment Methods:</strong> We accept payment methods supported by Stripe
                (credit cards, debit cards, and other methods as available)
              </li>
              <li>
                <strong>Failed Payments:</strong> If a payment fails, we will attempt to process it
                again. Continued payment failures may result in suspension of PRO benefits
              </li>
              <li>
                <strong>Receipts:</strong> You will receive email receipts for all successful
                payments
              </li>
            </ul>
            ...
            <p className='mb-4'>
              <strong>Important:</strong> If you dispute a charge with your bank or credit card
              company (chargeback) without first contacting us, your access to Steam Game Idler and
              all of its features may be permanently revoked. Fraudulent chargebacks cause
              significant harm to our small independent project.
            </p>
            <p className='mb-4'>
          ...
          <section>
            ...
            <p className='mb-4'>
              <strong>USE AT YOUR OWN RISK:</strong> While SGI is designed to work within
              Steam&apos;s guidelines, the use of any third-party automation tool carries inherent
          ...
          <section>
            ...
            <ul className='list-disc pl-6 space-y-2 mb-4'>
              <li>
                <strong>Email:</strong> contact@steamgameidler.com (for billing and subscription
                inquiries)
              </li>
              <li>
                <strong>In-App Help Desk:</strong> Available in the applications title bar menu
                under &quot;Help Desk&quot;
              </li>
              <li>

...
SGI will exclude games that you already own, but you will need to make sure your games list data in SGI is up to date by clicking the `Refresh` button in `Your Games`

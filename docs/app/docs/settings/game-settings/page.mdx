...
* **Considerations:** This only affects games that are idled by [Playtime Booster](/docs/features/playtime-booster) and [Auto Idler](/docs/features/auto-idler), and does not affect games idled by [Card Farming](/docs/features/card-farming) or [Achievement Unlocker](/docs/features/achievement-unlocker)

## Max card drops

* **Purpose:** Set the maximum amount of card drops you want [Card Farming](/docs/features/card-farming) to farm for this game before it stops
...
* **Purpose:** Set the maximum amount of achievements you want [Achievement Unlocker](/docs/features/achievement-unlocker) to unlock for you. SGI will stop unlocking achievements for this game and remove it from the `achievement unlocker list` when the limit is reached
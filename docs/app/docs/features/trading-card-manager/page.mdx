...
When you sell or earn trading cards you will need to manually refresh the Trading Card Manager list to see the changes. You can do this by clicking the <MockButton type='refresh' /> button in the page header
...
<details>
    ...
    > No, SGI uses Valve's official [Steamworks SDK](https://partner.steamgames.com/doc/sdk) and interacts with Steam just like normal gaming activity.
</details>
...
<details>
    ...
    >
    > However, providing your own Steam Web API key in the [settings > general](/docs/settings/general) will allow you to use SGI with private profiles and game details.
</details>

<details>
    <summary>What makes this different from other Steam tools?</summary>
    > SGI combines multiple useful features into one modern application. Unlike other Steam tools, it offers card farming, achievement management, and playtime boosting in a single, user-friendly interface.
</details>
...
<details>
    <summary>Can I use SGI to idle in-game items?</summary>
...
<details>
    <summary>How many games can SGI handle simultaneously?</summary>
    > You can idle a max of 32 games simultaneously. This is a limitation of the Steam client.
</details>

...
<CopyableFAQ id='Why are some games not showing up in my games list in SGI?' question='Why are some games not showing up in my games list in SGI?'>
...
<CopyableFAQ id='Do I need to make my Steam profile and game details public for the Steam card idler to work?' question='Do I need to make my Steam profile and game details public for the Steam card idler to work?'>
...
<CopyableFAQ id='What makes this different from other Steam tools?' question='What makes this different from other Steam tools?'>
...
<CopyableFAQ id='Do I need an internet connection to use SGI?' question='Do I need an internet connection to use SGI?'>
...
<CopyableFAQ id='What is the "Do you want to allow public/private networks to access this app" message when I first launched SGI?' question='What is the "Do you want to allow public/private networks to access this app" message when I first launched SGI?'>
...
<CopyableFAQ id='Can I get banned for using a Steam idler or achievement unlocker?' question='Can I get banned for using a Steam idler or achievement unlocker?'>
...
<CopyableFAQ id='What are trading cards and how do they work with Steam idlers?' question='What are trading cards and how do they work with Steam idlers?'>
...
<CopyableFAQ id='Why am I not getting any card drops with the Steam card idler?' question='Why am I not getting any card drops with the Steam card idler?'>
...
<CopyableFAQ id='How do I know if my games have card drops remaining?' question='How do I know if my games have card drops remaining?'>
...
<CopyableFAQ id='How long does it take for cards to drop?' question='How long does it take for cards to drop?'>
...
<CopyableFAQ id='Can I idle games I do not own?' question='Can I idle family shared games?'>
...
<CopyableFAQ id='Why am I unable to idle some games?' question='Why am I unable to idle some games?'>
...
<CopyableFAQ id='Why is my playtime not increasing on Steam?' question='Why is my playtime not increasing on Steam?'>
...
<CopyableFAQ id='Can I use SGI to idle in-game items or join game servers?' question='Can I use SGI to idle in-game items or join game servers?'>
    > No. SGI cannot idle in-game items or join game servers as it doesn't run an actual instance of the game.
</CopyableFAQ>

<CopyableFAQ id='How many games can SGI idle simultaneously?' question='How many games can SGI idle simultaneously?'>
...
<CopyableFAQ id='Why am I unable to unlock/lock some achievement for some games?' question='Why am I unable to unlock/lock some achievement for some games?'>
...
<CopyableFAQ id='Why do I see "No achievements found" and "No statistics found" on the game&apos;s achievement manager screen?' question='Why do I see "No achievements found" and "No statistics found" on the game&apos;s achievement manager screen?'>
...
<CopyableFAQ id='Will unlocking achievements affect my completion percentage on tracking sites?' question='Will unlocking achievements affect my completion percentage on tracking sites?'>
...
<CopyableFAQ id='Can I unlock achievements for games I don&apos;t own?' question='Can I unlock achievements for games I don&apos;t own?'>
...
<CopyableFAQ id='Can I unlock achievements for family shared games?' question='Can I unlock achievements for family shared games?'>
...
<CopyableFAQ id='Is there a way to unlock achievements in a specific order?' question='Is there a way to unlock achievements in a specific order?'>
...
<CopyableFAQ id='Steam is not running' question='Steam is not running'>
...
<CopyableFAQ id='No Steam users found' question='No Steam users found'>
...
<CopyableFAQ id='Add some games to your card farming list or enable &apos;all games&apos; in &apos;settings > card farming&apos;' question='Add some games to your card farming list or enable &apos;all games&apos; in &apos;settings > card farming&apos;'>
...
<CopyableFAQ id='There are no games in your achievement unlocker list' question='There are no games in your achievement unlocker list'>
...
<CopyableFAQ id='Account mismatch between Steam and SGI' question='Account mismatch between Steam and SGI'>
...
<CopyableFAQ id='Incorrect card farming credentials' question='Incorrect card farming credentials'>
...
<CopyableFAQ id='Missing card farming credentials' question='Missing card farming credentials in "settings > card farming"'>
...
<CopyableFAQ id='Card farming credentials need to be updated' question='Card farming credentials need to be updated in "settings > general"'>

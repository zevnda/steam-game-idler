        ...
        <div className='space-y-8'>
          ...
          <section>
            ...
            <ul className='list-disc pl-6 space-y-2 mb-4'>
              <li>
                <strong>Steam ID:</strong> Your unique Steam identifier to manage your game library
                and settings
              </li>
              <li>
              ...
              <li>
                <strong>Game Library Data:</strong> Information about games in your Steam library,
                including achievements and trading card data
              </li>
              <li>
                <strong>Steam Web API Key:</strong> If provided, used to access enhanced Steam
                features (optional)
              </li>
            </ul>
            ...
            <ul className='list-disc pl-6 space-y-2 mb-4'>
              <li>
                <strong>Steam Session Cookies:</strong> Including sessionid, steamLoginSecure, and
                steamMachineAuth tokens for card farming features
              </li>
            </ul>
            <h3 className='text-xl font-medium mb-3'>1.3 Application Settings</h3>
            <ul className='list-disc pl-6 space-y-2 mb-4'>
              <li>
                <strong>User Preferences:</strong> Your application settings including achievement
                unlocker configurations, card farming preferences, and general settings
              </li>
              <li>
                <strong>Game-Specific Settings:</strong> Custom configurations for individual games
                (idle time limits, achievement unlock limits, etc.)
              </li>
              <li>
                <strong>Application State:</strong> Information about your current session and
                application usage
              </li>
            </ul>
            ...
            <ul className='list-disc pl-6 space-y-2 mb-4'>
              <li>
                <strong>Steam ID:</strong> To link your PRO subscription to your Steam account and
                verify subscription status
              </li>
              <li>
                <strong>Email Address:</strong> Required for billing communications, receipts, and
                subscription management notifications
              </li>
              <li>
                <strong>Discord User ID:</strong> Optional, only stored if you manually claim the
                Discord donator role through our Discord server
              </li>
              <li>
                <strong>Stripe Customer ID:</strong> A reference identifier linking your
                subscription to Stripe&apos;s payment system (we do not store any credit card or
                payment details)
              </li>
              <li>
                <strong>Subscription Status:</strong> Information about your active subscription
                tier, renewal date, and status
              </li>
            </ul>
            <p className='mb-4'>
              <strong>Important:</strong> We do NOT store any credit card numbers, banking
              information, or payment details. All payment information is securely handled and
          ...
          <section>
            ...
            <ul className='list-disc pl-6 space-y-2 mb-4'>
              <li>
                <strong>Game Management:</strong> To idle games, unlock achievements, and manage
                trading cards in your Steam library
              </li>
              <li>
                <strong>Session Management:</strong> To maintain your login state and validate Steam
                sessions for card farming
              </li>
              <li>
                <strong>Settings Persistence:</strong> To save and restore your application
                preferences between sessions
              </li>
              <li>
                <strong>Steam API Integration:</strong> To retrieve game information, achievement
                data, and trading card details
              </li>
              <li>
                <strong>PRO Subscription Management:</strong> To verify your subscription status,
                provide PRO features, send billing notifications, and manage your subscription
                lifecycle
              </li>
              <li>
                <strong>Communication:</strong> To send you important updates about your
                subscription, billing receipts, and service announcements (PRO subscribers only)
              </li>
            </ul>
            <p className='mb-4'>
          ...
          <section>
            ...
            <p className='mb-4'>
              <strong>PRO Subscription Data:</strong> We retain your subscription information for as
              long as your subscription is active, plus an additional period after cancellation as
              required for billing records, dispute resolution, and legal compliance (typically 7
              years). You may request deletion of your data by contacting us, subject to our legal
              obligations.
            </p>
          ...
          <section>
            ...
            <p className='mb-4'>
              <strong>Desktop Application:</strong> We do not use any third-party analytics or
              tracking services in the SGI desktop application. However, Google AdSense may be used
              for advertising, as described in section 4.3. SGI does not collect telemetry data or
              usage statistics from your application usage.
              <br />
              <strong>Website:</strong> Our website uses Google AdSense for advertising (see section
              4.3) and Next.js Analytics to collect aggregated, non-personal usage statistics to
              help improve site performance and user experience. No personally identifiable
              information is collected by Next.js Analytics. We do not use additional analytics
              tracking services beyond what is required for ad delivery, consent management, and
          ...
          <section>
            ...
            <p className='mb-4'>
              ...
              data to personalize ads and measure ad performance. You may see a consent message
              (Consent Management Platform, CMP) when using our site or app, allowing you to manage
              your preferences for personalized ads and data collection.
            </p>
            <ul className='list-disc pl-6 space-y-2 mb-4'>
              <li>
                <strong>Third-Party Cookies:</strong> Google and partners may set cookies to deliver
                and personalize ads.
              </li>
              <li>
                <strong>User Consent:</strong> You can accept or manage your ad and data preferences
                via the CMP message shown in our website or app.
              </li>
              <li>
                <strong>Scope:</strong> This applies to both the Steam Game Idler website and
                desktop application.
              </li>
              <li>
          ...
          <section>
            ...
            <ul className='list-disc pl-6 space-y-2 mb-4'>
              <li>
                <strong>Steam API Communication:</strong> Only the necessary data to communicate
                with Steam&apos;s official APIs for application functionality
              </li>
              <li>
                <strong>Payment Processing:</strong> When you subscribe to PRO, your payment
                information is shared with Stripe to process your subscription. We receive only
                subscription status and a customer reference ID from Stripe
              </li>
              <li>
                <strong>Legal Requirements:</strong> If required by law, legal process, or
                governmental request
              </li>
              <li>
                <strong>Security Purposes:</strong> To protect the rights, property, or safety of
                SGI users or the public
              </li>
            </ul>
            <p className='mb-4'>

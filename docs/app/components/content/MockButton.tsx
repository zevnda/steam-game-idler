...
export default function MockButton({ type, content }: MockButtonProps) {
  if (type === 'content') {
    return (
      <span className='inline-flex align-middle items-center justify-center bg-icon text-icon-light dark:text-icon-dark text-[12px] font-semibold px-2 rounded-full shadow-sm select-none gap-1'>
        {content}
      </span>
    )
  } else if (type === 'lock') {
    ...
    return (
      <span className='inline-flex align-middle items-center justify-center bg-icon text-icon-light dark:text-icon-dark text-[12px] font-semibold px-2 rounded-full shadow-sm select-none gap-1 h-8'>
    ...
    return (
      <span
        className={`inline-flex align-middle items-center justify-center bg-icon text-icon-light dark:text-icon-dark text-[12px] font-semibold px-2 rounded-full shadow-sm select-none gap-1 ${content === undefined && 'h-8'}`}
      >
    ...
    return (
      <span className='inline-flex align-middle items-center justify-center bg-icon text-icon-light dark:text-icon-dark text-[12px] font-semibold px-1 rounded-full shadow-sm select-none gap-1 h-8'>

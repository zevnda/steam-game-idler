...
import ComparisonSection from '@/app/(marketing)/pro/_components/ComparisonSection'
import { fetchProData } from '@/app/(marketing)/pro/_components/data'
import FAQSection from '@/app/(marketing)/pro/_components/FAQSection'
import FeatureDetailsSection from '@/app/(marketing)/pro/_components/FeatureDetailsSection'
import FeaturesSection from '@/app/(marketing)/pro/_components/FeaturesSection'
import HeroSection from '@/app/(marketing)/pro/_components/HeroSection'
import TierCardsSection from '@/app/(marketing)/pro/_components/TierCardsSection'

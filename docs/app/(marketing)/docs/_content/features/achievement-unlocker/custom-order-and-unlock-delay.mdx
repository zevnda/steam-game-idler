...
Unlock delays override the global value set in [Settings → Achievement Unlocker → Unlock Interval](/docs/settings/achievement-unlocker#unlock-interval). If no unlock delay is set, the global value is used.
...
<Callout type="info">
    Importing custom unlock timings *(Pro — Gamer tier)* from another player's profile can also populate order and delays automatically — see [Import Timings](/docs/features/achievement-unlocker/import-timings)
</Callout>

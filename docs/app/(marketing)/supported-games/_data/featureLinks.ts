...
export const FEATURE_DOCS_LINKS: Record<string, string> = {
  ...
  'Idling & Playtime': '/docs/features/playtime-booster',
  'Passive Playtime': '/docs/features/playtime-booster',
  'Multi-Game Idling': '/docs/features/playtime-booster',
  'Multi-Game Sessions': '/docs/features/playtime-booster',
  'Lightweight Idling': '/docs/features/playtime-booster',
